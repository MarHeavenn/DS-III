...
| RQ-05 | Sistema | La aplicación debe cumplir con restricciones de negocio y regulatorias para la gestión de inventario y protección de datos. | Control de acceso y mecanismos de consentimiento de datos. | Operaciones de modificación de inventario y almacenamiento de datos personales. | Se debe restringir la modificación del inventario solo a administradores y asegurar que los datos personales sean almacenados con consentimiento explícito. | Los cambios en el inventario deben ser accesibles únicamente para administradores, y el sistema debe registrar y solicitar consentimiento antes de procesar datos personales. |
