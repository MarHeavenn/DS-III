...
| **US-14**   | Como administrador, quiero recibir alertas automáticas cuando se detecten fallos críticos o comportamientos inesperados.|<br>- Si un microservicio deja de responder, se debe generar una alerta en menos de cinco segundos.<br>- Si el tiempo de respuesta de un servicio supera los cinco segundos, se debe registrar una advertencia.<br>- Las alertas deben enviarse por correo.|
...
| *RQ-05* | Desarrollador| 	Se requiere modificar un microservicio sin afectar el funcionamiento de otros servicios. | Código y documentación de los microservicios. | Desarrollo y pruebas de integración. |La arquitectura debe permitir modificaciones independientes. Los cambios en más de un microservicio deben documentarse y probarse antes de su despliegue. | El 90% de las modificaciones deben completarse sin afectar más de un microservicio y sin fallos en integración. |
